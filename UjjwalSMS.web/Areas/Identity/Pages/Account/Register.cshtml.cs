...
namespace UjjwalSMS.web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public readonly ICrudService<Student> _student;
        ...
        public SelectList StudentInfoList { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            ReturnUrl = returnUrl;
            var studentInfoList = await _student.GetAllAsync();
            Students = studentInfoList; 
            StudentInfoList = new SelectList(studentInfoList, "Id", "FullName");
